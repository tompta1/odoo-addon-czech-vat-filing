...
```bash
git add .
git commit -m "release: v19.0.20.0.0"
```

Create an annotated tag:

```bash
git tag -a v19.0.20.0.0 -m "Czech VAT filing release v19.0.20.0.0"
```
...
```bash
./scripts/release_pack_addons.sh v19.0.20.0.0
```

Artifacts are written to:

- `dist/v19.0.20.0.0/*.zip`
- `dist/v19.0.20.0.0/SHA256SUMS.txt`

## 5. Publish Targets

### GitHub Release

Create a release from tag `v19.0.20.0.0` and attach:
